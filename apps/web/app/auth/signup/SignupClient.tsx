        ...
        <main className="min-h-screen bg-[var(--surface-sunken)] flex items-center justify-center p-4">
            <Card className="w-full max-w-md">
                <CardHeader className="text-center space-y-2">
                    <CardTitle className="text-2xl font-bold text-[var(--text-primary)]">Create an account</CardTitle>
                ...
                <CardFooter className="flex justify-center border-t border-[var(--border-subtle)] pt-4 mt-2">
                    <Text size="sm" className="text-[var(--text-secondary)]">
                        ...
                        <Link href="/auth/login" className="text-[var(--interactive-default)] hover:text-[var(--interactive-hover)] font-medium">
                            Sign in
                        </Link>
                    </Text>
                </CardFooter>
