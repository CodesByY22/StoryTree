...
import { Button, Input, Label, Card, CardHeader, CardTitle, CardContent, Heading } from "@repo/ui";
        ...
        return (
            <div className="min-h-screen bg-[var(--surface-base)]">
                ...
                <main className="max-w-6xl mx-auto p-6 md:p-12 space-y-8 animate-pulse">
                    <div className="h-10 bg-[var(--surface-sunken)] rounded w-64 mb-6"></div>
                    <div className="h-64 bg-[var(--surface-sunken)] rounded w-full max-w-2xl"></div>
                </main>
            </div>
        );
    }
